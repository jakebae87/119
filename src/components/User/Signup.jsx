...
function Signup() {
    ...
    // };
        ...
        const onChangeNumber = (e)=>{
            ...
            const nuRegExp = /[0-9]/g;

            if(!nuRegExp.test(currentNumber)){
                setNumessage('정수로만 입력해 주세요');
                setIsnumber(false);
            }else{
                setNumessage('');
                setIsnumber(true);
        ...
        //모든항목 입력 검사
        const onSubmit = (e) => {
            if (name === ''|| id==='' || pw==='' || pw2==='' ||email==='' ||number=='') {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            <input  onChange={onChangeNumber}  type="text" className="number" name="last_phone_number" size="1" minLength="3" maxLength="4" required /><br/>

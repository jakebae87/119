                    ...
                    <div>
                        <table className="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <select name="year" id="year" className="birth">
                                            <option value="" disabled selected>년</option>
                                            {years.map((year) => (
                                                <option key={year} value={year}>{year}</option>
                                            ))}
                                        </select>
                                        <select name="month" id="month" className="birth">
                                            <option value="" disabled selected>월</option>
                                            {months.map((month) => (
                                                <option key={month} value={month}>{month}</option>
                                            ))}
                                        </select>
                                        <select name="day" id="day" className="birth">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        ...
                                        <input id="contact" type="text" className="number" name="second_phone_number" size="1" minLength="3" maxLength="4" required />
                                        <input type="text" className="number" name="last_phone_number" size="1" minLength="3" maxLength="4" required />
                                    </div>
                                </td>
                            </tr>
                        </table>
                        <Link to="./Success"><input type="submit" className="signupBtn" value="가입하기" /></Link>
                    </div>
                </form>
            </div>
        </div>
